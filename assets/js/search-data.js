...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-using-autopilot-computeclasses-on-gke-standard-clusters",
        
          title: 'Using Autopilot ComputeClasses on GKE Standard Clusters <svg width="1.2rem" height="1.2rem" top=".5rem" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><path d="M17 13.5v6H5v-12h6m3-3h6v6m0-6-9 9" class="icon_svg-stroke" stroke="#999" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
        
        description: "",
        section: "Posts",
        handler: () => {
          
            window.open("https://medium.com/google-cloud/using-autopilot-computeclasses-on-gke-standard-clusters-66a2b0662295?source=rss-4dd39a6b908a------2", "_blank");
